...
{
public:
	MyDirect3DDevice9(IDirect3DDevice9*);
	~MyDirect3DDevice9(void);
...
extern std::function<void (void)> OnFrameBeginRender;
extern std::function<void (void)> OnFrameEndRender;
